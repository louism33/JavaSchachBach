...
private double scaleFac;
    ...
    BufferedImage blackPawn, blackKnight, blackBishop, blackRook, blackQueen, blackKing;
    BufferedImage chessboard, bigChessboard;
    ...
    void draw(ChessBoard board, Graphics2D g2d) {
        this.board = board;

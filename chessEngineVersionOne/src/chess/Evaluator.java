...
public class Evaluator {
    ...
    private static final int CBIT   = ChessBoard.CBIT;

    private static final int INFINITY=1000000, MATE = 300000;

    private int numberOfBoardsEvaluated;
    private MasterList masterList;

    public Evaluator() {
        this.numberOfBoardsEvaluated = 0;
    }

//    public Evaluator(MasterList masterList) {
//        this.numberOfBoardsEvaluated = 0;
//        this.masterList = masterList;
//        // create class of scores, scoredboards?
//
//    }

//    Move selectBestMove (MasterList masterList) {
//        Move move = new Move();
//
//        List<Integer> scoredOriginalMoves = giveAllBoardListsAScore();
//
//        move = selectMostDesirableMove(this.masterList, scoredOriginalMoves);
//
//        return move;
//    }
...
//    List<Integer> giveAllBoardListsAScore() {
//        List<Integer> scoredOriginalMoves = new ArrayList<>();
//
//        List<List<Integer>> allScores = new ArrayList<>();
//
//        for (List<ChessBoard> expandedBoard : this.masterList.getMasterList()) {
//            List<Integer> expandedScores = giveAllBoardsAScore(expandedBoard);
//            allScores.add(expandedScores);
//        }
//
//        scoredOriginalMoves = extractMinOrMaxScore(allScores);
//
//        return scoredOriginalMoves;
//    }
//
//    Move selectMostDesirableMove (MasterList masterList, List<Integer> scoredBoards) {
//        boolean chooseMinimum = false; //TODO
//
//        List<Move> moveList = masterList.getOriginalBoard().generateMoves();
//
//        Move mostDesirableScoringMove = new Move();
//        int mostDesirableMove = 0;
//        if(chooseMinimum) {
//            mostDesirableMove = Collections.min(scoredBoards);
//        }
//        else {
//            mostDesirableMove = Collections.max(scoredBoards);
//        }
//
//        int indexOfMostDesirableMove = scoredBoards.indexOf(mostDesirableMove);
//        mostDesirableScoringMove = moveList.get(indexOfMostDesirableMove);
//        return mostDesirableScoringMove;
//    }
//

//    private List<Integer> giveAllBoardsAScore (List<ChessBoard> expandedBoard){
//        List<Integer> scoredBoard = new ArrayList<>();
//
//        for (ChessBoard b : expandedBoard) {
//            int score = eval(b);
//            scoredBoard.add(score);
//            this.numberOfBoardsEvaluated ++;
//            //TODO: time
//            //				if (Engine.timeup() || Engine.earlyAbort) {
//            //					break;
//            //				}
//        }
//
...
//    List<Integer> extractMinOrMaxScore (List<List<Integer>> listListScores) {
//        List<Integer> scoredOriginalMoves = new ArrayList<>();
//        for (List<Integer> theseScores : listListScores) {
//            int mostDesirableMove = 0;
//            mostDesirableMove = Collections.min(theseScores);
//            scoredOriginalMoves.add(mostDesirableMove);
//        }
//        return scoredOriginalMoves;
//    }
//
